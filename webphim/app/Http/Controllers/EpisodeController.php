...
class EpisodeController extends Controller
{
    public function create(Request $request, $id)
    {
        try {
            ...
            return view('admin.episode.add', compact('title', 'movie', 'episode'));
        } catch (Exception $e) {
    ...
    public function show()
    {
        ...
        return view('admin.episode.list', compact('title', 'movie'));
    }
    ...
    public function edit(Request $request, $id)
    {
        try {
            ...
            return view('admin.episode.edit', compact('title', 'episodeEdit', 'movie'));
        } catch (Exception $e) {
            Session::flash('error', 'Phim không tồn tại');
