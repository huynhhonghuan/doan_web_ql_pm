    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="file"  class="form-control" id="hinhanh" name="hinhanh" value="{{old('hinhanh')}}" onclick="return showImage(this)">
                {{-- <img src="" id="image"> --}}
                <div id="image">
...
<script type="text/javascript">
    ...
    // Lấy giá trị của thẻ Input:File
    var image = document.getElementById('hinhanh').files[0];
